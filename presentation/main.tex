...
\begin{frame}
	...
	%index.html, cordova.js import und deviceready listener, ratchet zeigen
	%Verzeichnisstruktur erklären?
	%Workshop-App in Android zeigen (TODO: Bildschirm des Geräts zeigen)
	%%Directory, GPS, 
	%Workshop-App im Browser zeigen
\end{frame}
